...
import { GenesetPanelComponent } from 'app/component/workspace/geneset-panel/geneset-panel.component';
...
export class GraphConfig {
  ...
  enableShape = true;
  enableSize = false;
  enableMarkerBaseSize = false; // MJ TODO Make this false but fix. // Make scatter plot markers smaller or larger than default size
  enableGenesetOverlay = false;

  uiOptions:any = {};  // In descendant, set markerBaseSize = 10;
  ...
  public static cloneFromAny(obj:any): GraphConfig {
    ...
    console.log('========== cloneFromAny GraphConfig');

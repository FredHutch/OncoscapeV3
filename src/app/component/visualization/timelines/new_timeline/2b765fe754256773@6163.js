...
md`# Timeline Conversion  build 0208`
)}

function _2(md){return(
md`Recent Changes:
For LARGE TEST, set smallTest=False in loadedRawData.`
)}
...
*/
  ...
  console.log(">> Start sort at " + startTime)
...
function _74(dataLoadedAction){return(
...
function _90(tlConfig){return(
tlConfig.firmColors
)}

function _91(getData){return(
getData()[0].events[0]
)}
...
function _106(transformData1){return(
...
function _116(rawDataFromJson){return(
...
function _122(dataLoadedAction){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["tlConfig"], _65);
  ...
  main.variable(observer()).define(["dataLoadedAction"], _74);
  ...
  main.variable(observer()).define(["html"], _87);
  ...
  main.variable(observer()).define(["tlConfig"], _90);
  main.variable(observer()).define(["getData"], _91);
  ...
  main.variable(observer()).define(["transformData1"], _106);
  ...
  main.variable(observer()).define(["rawDataFromJson"], _116);
  ...
  main.variable(observer()).define(["dataLoadedAction"], _122);
  ...
  main.variable(observer()).define(["html"], _139);

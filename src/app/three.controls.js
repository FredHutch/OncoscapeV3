...
THREE.TransformGizmoTranslate = function () {
  ...
  this.handleGizmos = {
    ...
    XYZ: [
      [ new THREE.Mesh( new THREE.OctahedronGeometry( 0.1, 0 ), new GizmoMaterial( { color: 0x039BE5, opacity: 1 } ) ), [ 0, 0, 0 ], [ 0, 0, 0 ] ]
    ],
...
THREE.TransformControls = function ( camera, domElement ) {
  ...
  this.update = function () {
    ...
    scale = worldPosition.distanceTo( camPosition ) / 3 * scope.size;

...
export class AccessS3 {
    ...
    public static fetchSupportingPresigned = (env: string, input: RequestInfo, initWithToken: RequestInit, fromPrivate:boolean, consoleContext:LoaderWorkerGlobalScope = null) => {
        if (fromPrivate) {
